    ...
    const svg = `
      <svg width="400" height="200" viewBox="0 0 400 200" xmlns="http://www.w3.org/2000/svg">
        ...
        <g transform="translate(20, 110)">
            <text font-family="Segoe UI, Helvetica, Arial" font-size="16" fill="${t.icon}">📦 Repositories:</text>
            <text x="150" font-family="Segoe UI, Helvetica, Arial" font-size="16" fill="${t.text}" font-weight="bold">${repos}</text>
        </g>

        <g transform="translate(20, 150)">
            <text font-family="Segoe UI, Helvetica, Arial" font-size="16" fill="${t.icon}">👥 Followers:</text>
